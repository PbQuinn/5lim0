...
# This tool randomly generates nested expression trees with optional brackets based on a given seed.
...
NR_TESTS = 42          # nr of expressions to test
PRINT_GENERATED_FUNCTIONS = True # (True) Print all expressions / (False) print only warnings and faulty expressions
...
for i in range(NR_TESTS):
    ...
    if (not PASS):
        ...
        print(f"(i={i}): {expr}, expected {value}, got {transformer_value} ")
if all_pass:
